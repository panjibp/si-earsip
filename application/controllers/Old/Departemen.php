...
class Departemen extends CI_Controller
{
    ...
    {
        $departemen = $this->Tbl_departemen_model->get_all();

        // $data = array(
        //     'departemen_data' => $departemen
        // );

        $data['departemen_data'] = $departemen;
        $data['user'] = $this->db->get_where('user', ['username' => $this->session->userdata('username')])->row_array();

        $this->template->load('template','tbl_departemen_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'nama_departemen' => $row->nama_departemen,
            ...
            $this->template->load('template','tbl_departemen_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->load('template','tbl_departemen_form', $data);
    }
    ...
    public function word()
    {
        ...
        $this->load->view('tbl_departemen_doc',$data);
    }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2017-11-05 20:17:21 */
/* http://harviacode.com */